...
"[project]/src/app/watch/[type]/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function WatchPage() {
    ...
    const [source, setSource] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('embedsu');
    const [sourcesList, setSourcesList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [autoSwitch, setAutoSwitch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [videoErrorCount, setVideoErrorCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [showWatchLater, setShowWatchLater] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [contextMenuPos, setContextMenuPos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        x: 0,
        y: 0
    });
    ...
    const [episodeList, setEpisodeList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [similar, setSimilar] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [similarLoading, setSimilarLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
            __turbopack_context__.r("[project]/src/sources.mjs [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then({
                "WatchPage.useEffect": (mod)=>{
                    let sources = mod.availableSources || [];
                    // Always put multiembed first if available
                    const multiembedIdx = sources.findIndex({
                        "WatchPage.useEffect.multiembedIdx": (s)=>s.id === 'multiembed'
                    }["WatchPage.useEffect.multiembedIdx"]);
                    if (multiembedIdx > -1) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
            ...
            async function fetchContent() {
                ...
                try {
                    console.log("Fetching ".concat(type, " with ID: ").concat(id));
                    if (type === 'movie') {
                        const res = await fetch("".concat(TMDB_BASE, "/movie/").concat(id, "?api_key=").concat(TMDB_API_KEY, "&append_to_response=credits,similar"));
                        if (res.ok) {
                        ...
                        const res = await fetch("".concat(TMDB_BASE, "/tv/").concat(id, "?api_key=").concat(TMDB_API_KEY, "&append_to_response=credits,similar"));
                        if (res.ok) {
                            contentData = await res.json();
                    ...
                    if ((type === 'tv' || type === 'anime') && contentData && contentData.number_of_seasons) {
                        setSeasons(Array.from({
                            ...
                            "WatchPage.useEffect.fetchContent": (_, i)=>i + 1
                        }["WatchPage.useEffect.fetchContent"]));
                        setSelectedSeason(1);
                    } else {
                        setSeasons([]);
                    }
        ...
        "WatchPage.useEffect": ()=>{
            ...
            async function fetchEpisodes() {
                if (type === 'tv' && content && selectedSeason) {
                    ...
                    const res = await fetch("".concat(TMDB_BASE, "/tv/").concat(id, "/season/").concat(selectedSeason, "?api_key=").concat(TMDB_API_KEY));
                    if (res.ok) {
                    ...
                    if (content.anime_type === 'Movie') {
                        ...
                        setEpisodes(Array.from({
                            ...
                            "WatchPage.useEffect.fetchEpisodes": (_, i)=>i + 1
                        }["WatchPage.useEffect.fetchEpisodes"]));
                        setEpisodeList([]);
                        setSelectedEpisode(1);
                    }
                } else {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
            ...
            const src = sourcesList.find({
                "WatchPage.useEffect": (s)=>s.id === source
            }["WatchPage.useEffect"]) || sourcesList[0];
            let url = '';
            if (type === 'movie') {
                ...
                if (content.tmdb_id) {
                    ...
                    const animeSource = sourcesList.find({
                        "WatchPage.useEffect": (s)=>s.id === 'vidsrccc'
                    }["WatchPage.useEffect"]) || sourcesList[0];
                    if (animeSource) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
            ...
            async function fetchSimilar() {
                ...
                let results = [];
                if (type === 'movie') {
                    const res = await fetch("".concat(TMDB_BASE, "/movie/").concat(id, "/similar?api_key=").concat(TMDB_API_KEY));
                    if (res.ok) {
                        const data = await res.json();
                        results = data.results || [];
                    }
                } else if (type === 'tv') {
                    const res = await fetch("".concat(TMDB_BASE, "/tv/").concat(id, "/similar?api_key=").concat(TMDB_API_KEY));
                    if (res.ok) {
                        const data = await res.json();
                        results = data.results || [];
                    }
                    ...
                    try {
                        if (content && content.title) {
                            ...
                            const res = await fetch("".concat(CONSUMET_BASE, "/search?query=").concat(encodeURIComponent(content.title)));
                            if (res.ok) {
                                var _data_results;
                                const data = await res.json();
                                console.log('Enime recommendations received:', ((_data_results = data.results) === null || _data_results === void 0 ? void 0 : _data_results.length) || 0, 'items');
                                // Transform Consumet search results
                                results = (data.results || []).map({
                                    "WatchPage.useEffect.fetchSimilar": (anime)=>({
                                            id: anime.id,
                                            title: anime.title,
                                            name: anime.title,
                                ...
                                }["WatchPage.useEffect.fetchSimilar"]);
                            }
                        }
                    } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
            if (!content && !loading && type && id) {
                console.log("Content not found for ".concat(type, "/").concat(id, ", trying fallback..."));
                ...
                const tryFallback = {
                    "WatchPage.useEffect.tryFallback": async ()=>{
                        for (const fallbackType of fallbackTypes){
                            try {
                                console.log("Trying fallback to ".concat(fallbackType, "..."));
                                const res = await fetch("".concat(TMDB_BASE, "/").concat(fallbackType, "/").concat(id, "?api_key=").concat(TMDB_API_KEY, "&append_to_response=credits,similar"));
                                if (res.ok) {
                                    const fallbackData = await res.json();
                                    console.log("Fallback ".concat(fallbackType, " data found:"), fallbackData);
                                    setContent(fallbackData);
                                    // Update the URL to reflect the correct type
                                    window.history.replaceState(null, '', "/watch/".concat(fallbackType, "/").concat(id));
                                    break;
                                }
                            } catch (error) {
                                console.log("Fallback ".concat(fallbackType, " failed:"), error);
                            }
                        }
                    }
                }["WatchPage.useEffect.tryFallback"];
                tryFallback();
            }
        }
    }["WatchPage.useEffect"], [
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: videoUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                        src: videoUrl,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                content.vote_average && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                content.genres && content.genres.map((g)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: credits.cast.slice(0, 15).map((actor)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: actor.profile_path ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                src: "https://image.tmdb.org/t/p/w185".concat(actor.profile_path),
                                                                alt: actor.name,
                                                                width: 80,
                                                                height: 80,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: sourcesList.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "px-4 py-2 rounded-full font-semibold transition border text-sm min-w-[110px] text-center whitespace-nowrap\n                ".concat(source === s.id ? 'bg-purple-600 text-white border-purple-400 shadow' : 'bg-[#232329] text-white border-[#232329] hover:bg-cyan-900'),
                    ...
                    type === 'tv' && seasons.length > 0 && content && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-col gap-2 w-full",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex gap-2 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-cyan-400/30 scrollbar-track-transparent",
                                children: seasons.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "px-4 py-2 rounded-lg font-semibold transition border ".concat(selectedSeason === s ? 'bg-cyan-700 text-white border-cyan-400' : 'bg-[#232329] text-white border-[#232329] hover:bg-cyan-900'),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: episodeList.length > 0 ? episodeList.map((ep, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "flex flex-col items-start rounded-xl border transition p-0 overflow-hidden shadow-md ".concat(selectedEpisode === ep.episode_number ? 'border-purple-500 ring-2 ring-purple-400' : 'border-[#232329] hover:ring-2 hover:ring-cyan-400'),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ep.still_path ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        src: "https://image.tmdb.org/t/p/w500".concat(ep.still_path),
                                                        alt: ep.name || "Episode ".concat(ep.episode_number),
                                                        fill: true,
                                                        className: "object-cover w-full h-full"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/watch/[type]/[id]/page.tsx",
                                        ...
                                        lineNumber: 485,
                                        columnNumber: 21
                                    }, this)) : episodes.map((e)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "flex flex-col items-start rounded-xl border transition p-0 overflow-hidden shadow-md ".concat(selectedEpisode === e ? 'border-purple-500 ring-2 ring-purple-400' : 'border-[#232329] hover:ring-2 hover:ring-cyan-400'),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        className: "glass-toggle px-4 py-2 rounded-lg border border-white/20 dark:border-black/20 backdrop-blur-md bg-white/10 dark:bg-black/20 text-white font-semibold ".concat(isInWatchLater() ? 'bg-purple-600' : ''),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: similarLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 548,
                            columnNumber: 13
                        }, this) : similar.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "text-white/60 py-8",
                            ...
                            var _item_vote_average, _this;
                            var _item_id, _media_type;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: glassCard,
                                onClick: ()=>{
                                    const itemType = item.media_type || item.type || 'movie';
                                    router.push("/watch/".concat(itemType, "/").concat(item.id));
                                },
                            ...
                            }, "".concat(String((_item_id = item.id) !== null && _item_id !== void 0 ? _item_id : ''), "-").concat(String((_media_type = (_this = item) === null || _this === void 0 ? void 0 : _this.media_type) !== null && _media_type !== void 0 ? _media_type : type)), true, {
                                fileName: "[project]/src/app/watch/[type]/[id]/page.tsx",
                                lineNumber: 553,
                                columnNumber: 15
                            }, this);
            ...
            showWatchLater && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        watchLater.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: watchLater.map((item)=>{
                                ...
                                }, "".concat(idStr, "-").concat(typeStr), true, {
                                    fileName: "[project]/src/app/watch/[type]/[id]/page.tsx",
                                    lineNumber: 595,
                                    columnNumber: 21
                                }, this);
            ...
            showContextMenu && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        onClick: ()=>handleCopy((content === null || content === void 0 ? void 0 : content.title) || (content === null || content === void 0 ? void 0 : content.name) || '', 'Title'),
                        children: "Copy Title"
                    }, void 0, false, {
                        fileName: "[project]/src/app/watch/[type]/[id]/page.tsx",
                        lineNumber: 625,
...
_s(WatchPage, "UIr/FZNnNV/5mn6InxAvMOK0Bzc=", false, function() {
    return [
...
//# sourceMappingURL=_04bfa73d._.js.map