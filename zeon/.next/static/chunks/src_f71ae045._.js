...
function MoviesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoviesPage.useEffect": ()=>{
            setLoading(true);
            fetch("".concat(TMDB_BASE, "/movie/popular?api_key=").concat(TMDB_API_KEY, "&page=").concat(page)).then({
                "MoviesPage.useEffect": (res)=>res.json()
            }["MoviesPage.useEffect"]).then({
                "MoviesPage.useEffect": (data)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoviesPage.useEffect": ()=>{
            ...
            const handleStorage = {
                "MoviesPage.useEffect.handleStorage": (e)=>{
                    if (e.key === "watchLater") {
                        const updated = e.newValue ? JSON.parse(e.newValue) : [];
                        setWatchLater(updated);
                    }
                }
            }["MoviesPage.useEffect.handleStorage"];
            window.addEventListener("storage", handleStorage);
            return ({
                "MoviesPage.useEffect": ()=>window.removeEventListener("storage", handleStorage)
            })["MoviesPage.useEffect"];
        }
    }["MoviesPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const goToPage = (p)=>{
        router.push("/movies?page=".concat(p));
    };
...
_s(MoviesPage, "EfYfiMp9F2rJPbR+auDGAOK7VYA=", false, function() {
    return [
...
//# sourceMappingURL=src_f71ae045._.js.map